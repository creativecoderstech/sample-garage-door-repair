...
export const garageContentSeed: GarageContentSeed[] = [
  ...
  record("project-modern", "project", "modern-panel-inspiration", "Modern Panel Door Inspiration", "Representative inspiration for clean lines, restrained windows, and contemporary finishes.", "Use this representative image to discuss design direction; it is not a claim of completed work or product availability.", 510, { parentId: "page-gallery", featured: true, imageUrl: "/images/curated/hero-elegant-home.jpg", imageAlt: "Elegant contemporary home with a dark modern garage door", mediaMetadata: { ...localMedia("https://www.pexels.com/photo/8134850/"), attribution: "Pexels" } }),
  record("project-classic", "project", "classic-door-inspiration", "Classic Garage Door Inspiration", "Representative inspiration for traditional panels and window details.", "This licensed local asset is presented as style inspiration, not a customer project or installation claim.", 520, { parentId: "page-gallery", imageUrl: "/images/curated/gallery-classic-garage.jpg", imageAlt: "Contemporary white residence with two sectional garage doors", mediaMetadata: { ...localMedia("https://www.pexels.com/photo/4782382/"), attribution: "Pexels" } }),
  record("project-wood", "project", "wood-look-door-inspiration", "Architectural Door Inspiration", "Representative inspiration for refined materials and architectural contrast.", "Materials, finishes, fit, availability, and installation scope must be confirmed during replacement planning.", 530, { parentId: "page-gallery", imageUrl: "/images/curated/gallery-wood-garage.jpg", imageAlt: "Dark architectural garage doors set into a textured facade", mediaMetadata: { ...localMedia("https://www.pexels.com/photo/7996765/"), attribution: "Pexels" } }),
