...
const generatedLocalMedia = (): GarageMediaMetadata => ({
  sourceUrl: "original-generated-asset",
  license: "Original generated asset for Cumming Garage Door Service",
  attribution: "Cumming Garage Door Service",
  representative: true,
});
...
export const garageContentSeed: GarageContentSeed[] = [
  ...
  record("page-gallery", "page", "gallery", "Garage Door Style Inspiration", "Explore representative door styles and planning ideas for your home or commercial property.", "These original, representative images are design inspiration rather than a portfolio of completed Cumming Garage Door Service projects. They reflect garage-door styles and residential settings commonly seen around Cumming and Forsyth County. Use them to discuss panel design, windows, finish, insulation, hardware, and fit.", 70, { navigationLabel: "Gallery" }),
  ...
  record("project-modern", "project", "modern-panel-inspiration", "Southern Farmhouse Door Inspiration", "Representative inspiration for dark carriage-style doors on North Georgia farmhouse architecture.", "Use this representative image to discuss design direction; it is not a claim of completed work or product availability.", 510, { parentId: "page-gallery", featured: true, imageUrl: "/images/curated/gallery-cumming-farmhouse.jpg", imageAlt: "White Southern farmhouse-style home with a dark charcoal carriage garage door", mediaMetadata: generatedLocalMedia() }),
  record("project-classic", "project", "classic-door-inspiration", "Traditional Brick Home Door Inspiration", "Representative inspiration for white raised panels and arched window details.", "This original representative asset is presented as style inspiration, not a customer project or installation claim.", 520, { parentId: "page-gallery", imageUrl: "/images/curated/gallery-cumming-traditional.jpg", imageAlt: "Traditional red-brick North Georgia home with two white sectional garage doors", mediaMetadata: generatedLocalMedia() }),
  record("project-wood", "project", "wood-look-door-inspiration", "Craftsman Carriage Door Inspiration", "Representative inspiration for warm carriage-style doors with brick and fieldstone exteriors.", "Materials, finishes, fit, availability, and installation scope must be confirmed during replacement planning.", 530, { parentId: "page-gallery", imageUrl: "/images/curated/gallery-cumming-craftsman.jpg", imageAlt: "Wooded North Georgia Craftsman home with a brown carriage-style garage door", mediaMetadata: generatedLocalMedia() }),
