  ...
  if (contentError || settingsError) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-8 bg-background">
        ...
        <h2 className="text-3xl font-display uppercase tracking-tight mb-3">Content Unavailable</h2>
        <p className="text-muted-foreground max-w-md mb-8">We were unable to load the page content. Please check your connection and try again.</p>
