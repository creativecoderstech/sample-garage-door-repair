...
import { ShieldAlert, Store, Palette, Save, Loader2, ArrowLeft, Images } from "lucide-react";
  ...
  const onSubmit = (values: SettingsFormValues) => {
    ...
    updateSettings.mutate({ data: {
      ...
      onSuccess: () => {
        ...
        // Force a small delay to ensure local state/theme catches up smoothly visually
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="flex items-center justify-end gap-4 pt-4 border-t sticky bottom-0 bg-background/95 backdrop-blur py-4 -mx-4 px-4 sm:mx-0 sm:px-0">
              ...
              <Button type="submit" size="lg" className="min-w-[140px] font-bold" disabled={isSaving}>
