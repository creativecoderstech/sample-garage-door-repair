...
The admin panel at **https://admin.pennylanehomesolutions.com** uses Google Sign-In.
...
3. Under **Authorized redirect URIs**, click **+ ADD URI** and enter:
   ```
   https://admin.pennylanehomesolutions.com/api/auth/callback
   ```
4. Click **Save**.
...
> where `ADMIN_ORIGIN` is set to `https://admin.pennylanehomesolutions.com` in  
...
1. Visit **https://admin.pennylanehomesolutions.com**.
