...
const FALLBACK_FAQS = [
  {
    ...
    a: "I serve Canton, Woodstock, Holly Springs, Ball Ground, and surrounding Northern Atlanta Metro communities. If you're within 20 miles of Canton, GA, I can help."
  },
  {
...
export default function HomePage() {
  ...
  const phoneDisplay = siteSettings?.phone?.trim() || '(770) 555-1234';
  ...
  const testimonials = [
    {
      ...
      location: 'Canton, GA',
      rating: 5,
      text: "Brandon mounted our 65\" TV and ran all the cables through the wall. Showed up exactly on time and the work is flawless. You'd never know the cables were there.",
      initial: 'S'
    },
    {
      name: 'Marcus Johnson',
  ...
  return (
    <div className="min-h-screen bg-background noise-overlay">
      ...
      <section id="hero" className="relative overflow-hidden" aria-labelledby="hero-heading">
        ...
        {/* ═══════════════════════════════════════════════════════
            MOBILE: full-bleed photo — Brandon's face fills the
        ...
        <div className="lg:hidden relative" style={{ minHeight: 'calc(100svh - 3.75rem)' }}>
          ...
          <picture className="absolute inset-0 w-full h-full">
            ...
            <img
              src={heroSrc}
              alt="Brandon installing a light fixture — Penny Lane Home Solutions"
          ...
          <div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-10 space-y-4">
            ...
            <p className="text-white/75 text-sm leading-relaxed">
              Canton's most responsive handyman —{' '}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="reveal-on-scroll">
                <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/5 text-primary text-xs font-bold tracking-wide uppercase">
                  ...
                  Veteran Owned · Top Pro 2024 &amp; 2025 · Canton, GA
                </div>
                ...
                <p className="text-xl text-muted-foreground leading-relaxed mb-8 max-w-lg">
                  Canton's most responsive handyman. Brandon has completed{' '}
                  <strong className="text-foreground">660+ jobs</strong> across Northern Atlanta Metro — responding in{' '}
                  <strong className="text-foreground">41 minutes</strong> on average and rated{' '}
                  <strong className="text-foreground">{siteSettings?.thumbtackRating ?? '4.9'} ★</strong> across {siteSettings?.thumbtackReviewCount ? `${siteSettings.thumbtackReviewCount}+` : '500+'} verified reviews.
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-14 items-center">
            ...
            <div className="reveal-on-scroll" style={{ transitionDelay: '0.2s' }}>
              ...
              <div className="space-y-4 text-base text-muted-foreground leading-relaxed">
                <p>
                  I'm Brandon — a veteran who carried military precision into home repair. 
                  Penny Lane Home Solutions is built on one promise: show up on time, bring the right tools, 
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="flex items-center gap-3 p-4 rounded-xl bg-card border border-card-border shadow-sm">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">500+ verified reviews</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          {!tasksQuery.isError && tasks.length > 0 ? (
            ...
            <div className="reveal-on-scroll flex flex-col items-center justify-center gap-3 py-16 px-8 rounded-3xl border-2 border-dashed border-border bg-card/50 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-xs">Brandon is adding project photos — check back shortly.</p>
            </div>
          )}
        </div>
      </section>
              ...
              <div id="leave-review" className="mt-10 max-w-2xl mx-auto reveal-on-scroll scroll-mt-20">
                <div className="bg-card border-2 border-card-border rounded-3xl p-8 md:p-10 shadow-xl">
                  <div className="mb-8 text-center">
                    <h3 className="font-display font-bold text-3xl mb-3 tracking-tight">Worked with Brandon?</h3>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-10 reveal-on-scroll max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Based in Canton, GA — serving homes within about 20 miles across the Northern Atlanta Metro.
            </p>
          </div>
          <div className="grid lg:grid-cols-5 gap-8 items-stretch">
            ...
            <div className="lg:col-span-2 reveal-on-scroll bg-card border-2 border-card-border rounded-3xl p-8 shadow-lg flex flex-col justify-center" style={{ transitionDelay: '0.1s' }}>
              ...
              <ul className="grid grid-cols-2 gap-x-4 gap-y-3 mb-8">
                {['Canton', 'Woodstock', 'Holly Springs', 'Ball Ground', 'Waleska', 'Nelson', 'Free Home', 'Hickory Flat', 'Lebanon', 'Sutallee'].map((town) => (
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Not sure if you're in range? If you're within about 20 miles of Canton, GA 30115, the answer is almost certainly yes — just ask.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="booking" className="py-14 md:py-20 gradient-bg-subtle" style={{ scrollMarginTop: '4rem' }}>
        <div className="container mx-auto px-6 lg:px-12 max-w-3xl">
          <div className="text-center mb-8 reveal-on-scroll">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Fill out the short form below. Brandon reviews every request and confirms your time — usually within about 41 minutes.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              <div className="bg-white rounded-2xl px-8 py-5 shadow-lg inline-block">
                <img
                  src={logoFullImage}
                  alt="Penny Lane Home Solutions logo"
                  className="w-[13.8rem]"
                  width={221}
                  height={56}
                  loading="lazy"
            ...
            <p className="text-muted-foreground mb-2 font-medium">
              Professional handyman services • Northern Atlanta Metro
            </p>
            <p className="text-sm text-muted-foreground mb-8">
              Canton, GA • Woodstock • Holly Springs • Ball Ground
            </p>
            ...
            <div className="pt-8 border-t border-border">
              <p className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Penny Lane Home Solutions. Veteran owned & operated.
              </p>
            </div>
          </div>
        </div>
