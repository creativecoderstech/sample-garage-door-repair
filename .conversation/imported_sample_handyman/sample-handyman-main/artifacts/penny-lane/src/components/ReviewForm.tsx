        ...
        {!handedOff ? (
          <>
            ...
            <p className="text-muted-foreground leading-relaxed max-w-md mx-auto" data-testid="text-handoff-guidance">
              It's saved — Brandon will feature it on the site soon. Reviews like yours help neighbors find
              Brandon on Google — mind sharing it there too? One tap: we'll copy your words and open
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground leading-relaxed max-w-md mx-auto">
          Your feedback means a lot. Brandon will feature it in the client reviews above soon.
        </p>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="e.g. Canton, GA" data-testid="input-review-location" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
