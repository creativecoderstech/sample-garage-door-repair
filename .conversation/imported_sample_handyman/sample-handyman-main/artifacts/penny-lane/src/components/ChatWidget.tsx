...
const SESSION_KEY = 'penny-lane-chat-inquiry';
...
function greetingFor(name: string): ChatMessage {
  return {
    role: 'assistant',
    content: `Hey ${name}! I'm Brandon's AI assistant. I can help answer questions about services, pricing, scheduling, or anything else. What can I help you with today?`,
  };
}
        ...
        onError: () => {
          ...
          setMessages((prev) => [
            ...prev,
            {
              role: 'assistant',
              content:
                "Sorry, I'm having trouble connecting right now. Close chat and open it again to retry, or use the booking form / call Brandon.",
            },
          ]);
        },
      },
        ...
        >
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Share your name so Brandon can follow up. Phone is optional.
            </p>
          </div>
