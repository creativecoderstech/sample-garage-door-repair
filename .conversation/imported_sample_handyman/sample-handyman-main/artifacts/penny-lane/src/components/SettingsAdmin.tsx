...
import { ExternalLink, Loader2, Pencil, Phone, Save, Star, X } from 'lucide-react';
...
export function SettingsAdmin() {
  ...
  const saveSection = (section: SectionKey) => {
    ...
    if (!merged.notifyFromName) merged.notifyFromName = 'Penny Lane Home Solutions';
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="Penny Lane Home Solutions"
                        maxLength={80}
                        autoComplete="off"
                      />
                    </div>
