...
EXPORT_FILE="/tmp/penny-lane-prod-export.sql"

echo "==> Exporting production D1 (penny-lane-db)..."
pnpm exec wrangler d1 export penny-lane-db --remote --env production --output "$EXPORT_FILE"
