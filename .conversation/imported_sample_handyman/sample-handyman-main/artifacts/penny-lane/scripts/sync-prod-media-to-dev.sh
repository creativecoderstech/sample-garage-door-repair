...
# PRODUCTION bucket (penny-lane-media-prod) into the LOCAL dev R2 state,
...
PROD_MEDIA_URL="${PROD_MEDIA_URL:-https://pennylanehomesolutions.com/api/media}"
DEV_BUCKET="penny-lane-media-dev"
TMP_DIR="$(mktemp -d /tmp/penny-lane-media-sync.XXXXXX)"
