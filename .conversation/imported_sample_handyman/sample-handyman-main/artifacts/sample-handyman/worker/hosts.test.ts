...
const MATRIX: HostCase[] = [
  ...
  { hostname: "sample-handyman.replit.app",              clientKeep: true,  clientRedirect: false, workerKeepProd: false, isAdmin: false },
  { hostname: "sample-handyman-dev.example.workers.dev", clientKeep: true,  clientRedirect: false, workerKeepProd: true,  isAdmin: false },
  // Production marketing host: /admin should redirect to the admin subdomain.
  { hostname: "sample-handyman.samples.creativecoders.tech", clientKeep: false, clientRedirect: true, workerKeepProd: false, isAdmin: false },
  { hostname: "sample-handyman.com",         clientKeep: false, clientRedirect: true,  workerKeepProd: false, isAdmin: false },
  { hostname: "www.sample-handyman.com",     clientKeep: false, clientRedirect: true,  workerKeepProd: false, isAdmin: false },
  // Legacy admin hostname is no longer the admin subdomain.
  { hostname: "admin.sample-handyman.com",   clientKeep: false, clientRedirect: true,  workerKeepProd: false, isAdmin: false },
  // New admin subdomain.
  { hostname: "admin.sample-handyman.samples.creativecoders.tech", clientKeep: false, clientRedirect: false, workerKeepProd: false, isAdmin: true },
];
