...
interface __BaseEnv_Env {
	...
	ADMIN_ORIGIN: "https://admin.sample-handyman.samples.creativecoders.tech";
	PUBLIC_ORIGIN: "https://sample-handyman.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ADMIN_ORIGIN" | "PUBLIC_ORIGIN" | "SESSION_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
