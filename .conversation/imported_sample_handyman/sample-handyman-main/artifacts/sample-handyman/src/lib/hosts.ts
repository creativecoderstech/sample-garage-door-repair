...
export const ADMIN_HOST = 'admin.sample-handyman.samples.creativecoders.tech';
...
export const PUBLIC_HOST = 'sample-handyman.samples.creativecoders.tech';
...
export function keepPathBasedAdmin(
  ...
  return (
    ...
    hostname.includes('sample-handyman-dev')
  );
}
